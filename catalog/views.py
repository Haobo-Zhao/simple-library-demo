...
class BookListView(generic.ListView):
    ...
    # queryset = Book.objects.filter(title__icontains='adventure')[:5]  # Get 5 books containing the title adventure

    # def get_queryset(self):
    #     return Book.objects.filter(title__icontains='adventure')[:5]  # Get 5 books containing the title adventure
